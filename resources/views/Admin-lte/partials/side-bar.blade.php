       ...
       <!--    <li class="nav-item">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{route('actionItem')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Action Items</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{route('adminLteManageStock')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Movements </p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{route('transferAtoB')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>TRANSFER </p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="{{route('maincategories')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Main Categories</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{ route('toolKitView') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Toolkits</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('createNewTool') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Create New Tool(s)</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="#" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Bulk Tool Update</p>
                </a>
              </li>
            </ul>
          </li>
