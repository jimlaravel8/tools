  ...
  <div class="content-wrapper">
    <div class="container">
        ...
        <div class="card-header">
          ...
          <p class="text-muted float-left">Modify a Location</p>
          
          <button class="btn btn-small btn-primary float-right">Cancel</button>
  
          </div>
          <div class="card-body">
            <form action="{{url('locations/'.$locations->id.'/update')}}" method="post">
              @csrf
                <div class="row">
                  <div class="col-md-4">
                    <label for="subcategoryName">Name</label>
                    <input type="text" class="form-control" name="name" id="subcategoryName" value="{{$locations->name}}">
                  </div>
                  <div class="col-md-4">
                    <label for="warehouseDescription">Description</label>
                    <input type="text" class="form-control" name="description" id="locationDescription" value="{{$locations->description}}">
                  </div>
                  <div class="col-md-4">
                  </div>
                </div>
