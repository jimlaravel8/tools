  ...
  <div class="content-wrapper">
    <div class="container">
        ...
        <div class="card-header">
          ...
          <div class="card-body">
            <form action="{{url('brands/'.$brands->id.'/update')}}" method="post">
              @csrf
                <div class="row">
                  <div class="col-md-4">
                    <label for="subcategoryName">Name</label>
                    <input type="text" class="form-control" name="name" id="subcategoryName" value="{{$brands->name}}">
                  </div>
                  <div class="col-md-4">
                    <label for="warehouseDescription">Description</label>
                    <input type="text" class="form-control" name="description" id="locationDescription" value="{{$brands->description}}">
                  </div>
                  <div class="col-md-4">
                  </div>
                </div>
